...
function Test() {
  ...
  return (
    <div className="flex">
      ...
      <div className="w-[250px] h-screen border border-dark-grey rounded">
      ...
      <div className="flex flex-col flex-grow">
        ...
        <div className="flex flex-grow">
          ...
          <div className="w-[50%] h-screen border border-dark-grey border-l-gray-500 flex flex-col">
            <div className="flex justify-center items-center bg-primary text-primary-foreground space-x-3 py-1">
              <Button extra="w-full" onClick={handleClick} label="Click me" variant="primary" size="md" />
              <Button extra="w-full" onClick={handleClick} label="Hint" variant="primary" size="md" />
              <Button extra="w-full" onClick={handleClick} label="Submit" variant="primary" size="md" />
            </div>
